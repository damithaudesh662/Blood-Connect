...
export const RequestDetailScreen: React.FC<Props> = ({ route, navigation }) => {
  const { id, hospitalName, location, bloodType, distanceKm, urgency,latitude,longitude, } =route.params;
  ...
  return (
    <View style={styles.container}>
      ...
      <TouchableOpacity
        ...
        disabled={loading}
      >
        <Text style={styles.secondaryButtonText}>View location on map</Text>
      </TouchableOpacity>
