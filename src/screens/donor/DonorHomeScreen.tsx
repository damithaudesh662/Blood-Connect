...
export const DonorHomeScreen: React.FC = () => {
  ...
  // --- Helper to format date cleaner (e.g. "04 Apr 2026") ---
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.sectionHeaderRow}>
        <Text style={styles.sectionTitle} numberOfLines={1}>Emergency requests near you</Text>
        <TouchableOpacity
...
const styles = StyleSheet.create({
  ...
  statsRow: {
    flexDirection: "row",
    justifyContent: "space-between",
    gap: theme.spacing.sm, // Keep gap tight for 3 items
    marginBottom: theme.spacing.lg,
  },
  statCard: {
    flex: 1,
  ...
  sectionTitle: {
    ...
    fontWeight: "600",
    color: theme.colors.text,
    flex: 1, // This allows the text to shrink so button stays visible
    marginRight: 8, // Add space between text and button
  },
  responsesButton: {
