...
export const LoginScreen: React.FC<Props> = ({ navigation }) => {
  ...
  return (
    <View style={styles.container}>
      ...
      >
        {/* Using theme.colors.primary so it matches your title color */}
...
const styles = StyleSheet.create({
  ...
  // --- NEW STYLE ADDED ---
  backButton: {
    position: 'absolute', // "Floats" the button over the view
    top: 50,              // Adjust this value if it hits the status bar
    left: 20,             // Aligns with left padding
